         ...
         'segments': [], 'fields': [
            ...
            {'field': 'id', 'type': 'Number', 'is_filterable': True, 'is_sortable': True, 'is_read_only': False,
             ...
             'inverse_of': None, 'relationship': None, 'widget': None, 'validations': [{'type': 'is greater than',
                                                                                        'message': 'Ensure this value is greater than or equal to -9223372036854775808.',
                                                                                        'value': -9223372036854775808},
                                                                                       {'type': 'is less than',
                                                                                        'message': 'Ensure this value is less than or equal to 9223372036854775807.',
         ...
         'segments': [], 'fields': [
            ...
            {'field': 'votes', 'type': 'Number', 'is_filterable': True, 'is_sortable': True, 'is_read_only': False,
             ...
             'inverse_of': None, 'relationship': None, 'widget': None, 'validations': [
                {'type': 'is greater than', 'message': 'Ensure this value is greater than or equal to -2147483648.',
                 'value': -2147483648},
                {'type': 'is less than', 'message': 'Ensure this value is less than or equal to 2147483647.',
                 'value': 2147483647},
                {'type': 'is present', 'message': 'Ensure this value is not null or not empty'}]}]},
