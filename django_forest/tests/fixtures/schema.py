    ...
    {'name': 'Choice', 'is_virtual': False, 'icon': None, 'is_read_only': False, 'is_searchable': True,
     ...
     'fields': [{'field': 'id', 'type': 'Number', 'is_filterable': True, 'is_sortable': True, 'is_read_only': False,
                ...
                {'field': 'question', 'type': 'Number', 'is_filterable': True, 'is_sortable': True,
                 ...
                 'widget': None}, {'field': 'choice_text', 'type': 'String', 'is_filterable': True, 'is_sortable': True,
    ...
    {'name': 'Article', 'is_virtual': False, 'icon': None, 'is_read_only': False, 'is_searchable': True,
     ...
     'fields': [{'field': 'id', 'type': 'Number', 'is_filterable': True, 'is_sortable': True, 'is_read_only': False,
                ...
                {'field': 'headline', 'type': 'String', 'is_filterable': True, 'is_sortable': True,
                 ...
                 'validations': [{'type': 'is shorter than', 'message': 'Ensure this value has at most 100 characters',
                                  'value': 100},
                                 {'type': 'is present', 'message': 'Ensure this value is not null or not empty'}]},
    ...
    {'name': 'Permission', 'is_virtual': False, 'icon': None, 'is_read_only': False, 'is_searchable': True,
     ...
     'fields': [
         ...
         {'field': 'user', 'type': ['Number'], 'is_filterable': False, 'is_sortable': True, 'is_read_only': False,
          ...
          'inverse_of': 'user_set', 'relationship': 'HasMany', 'widget': None},
    ...
    {'name': 'User', 'is_virtual': False, 'icon': None, 'is_read_only': False, 'is_searchable': True,
     ...
     'fields': [{'field': 'id', 'type': 'String', 'is_filterable': True, 'is_sortable': True, 'is_read_only': False,
                ...
                {'field': 'password', 'type': 'String', 'is_filterable': True, 'is_sortable': True,
                 'is_read_only': False, 'is_required': False, 'is_virtual': False, 'default_value': None,
                 'integration': None, 'reference': None, 'inverse_of': None, 'relationship': None, 'widget': None,
                 'validations': [{'type': 'is shorter than', 'message': 'Ensure this value has at most 128 characters',
                                  'value': 128},
                                 {'type': 'is present', 'message': 'Ensure this value is not null or not empty'}]},
                ...
                {'field': 'username', 'type': 'String', 'is_filterable': True, 'is_sortable': True,
                 ...
                 'validations': [
                     ...
                     {'type': 'is shorter than', 'message': 'Ensure this value has at most 150 characters',
                      'value': 150}, {'type': 'is present', 'message': 'Ensure this value is not null or not empty'}]},
                {'field': 'first_name', 'type': 'String', 'is_filterable': True, 'is_sortable': True,
                 'is_read_only': False, 'is_required': False, 'is_virtual': False, 'default_value': None,
                 'integration': None, 'reference': None, 'inverse_of': None, 'relationship': None, 'widget': None,
                 'validations': [{'type': 'is shorter than', 'message': 'Ensure this value has at most 150 characters',
                                  'value': 150},
                                 {'type': 'is present', 'message': 'Ensure this value is not null or not empty'}]},
                ...
                {'field': 'email', 'type': 'String', 'is_filterable': True, 'is_sortable': True, 'is_read_only': False,
                 ...
                 'reference': None, 'inverse_of': None, 'relationship': None, 'widget': None, 'validations': [
                    {'type': 'is shorter than', 'message': 'Ensure this value has at most 254 characters',
                     'value': 254}, {'type': 'is present', 'message': 'Ensure this value is not null or not empty'}]},
